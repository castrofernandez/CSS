...
if (appSettings.edit) {
	...
	IdeaSlides.ApplicationAdapter = DS.FixtureAdapter.extend();
	
	IdeaSlides.Presentation.FIXTURES = appData.presentation;
	
	IdeaSlides.Slide.FIXTURES = appData.slides;
}
...
IdeaSlides.PresentationsRoute = Ember.Route.extend({
	...
	setupController: function(controller, model) {
    	...
    	controller.set('local', appSettings.local);
    	controller.set('userEdit', appSettings.edit);
    }
});
